...
public class PhoenixController {
    ...
    @RequestMapping(value = "/clear_register_status")
    public MessageResponse clearRegisterStatus(@RequestParam String phone) {
        return phoenixService.clearRegisterStatus(phone);
    }
